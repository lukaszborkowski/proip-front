...
export default function ChooseButton({ children, isActive, className, onClick }) {
    return (
        <button className={cn("text-base xl:text-lg uppercase border w-full font-bold px-[66px] py-4 rounded-[24px] transition duration-300 hover:scale-110 ", className, {
